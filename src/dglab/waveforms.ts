import {
  FRAME_DURATION_MS,
  MAX_PULSE_FRAMES_PER_SEND,
  clampInt,
  isPulseFrameHex,
  simpleWaveFrame
} from "./protocol.js";

export type WaveformPreset = "test" | "constant" | "breath" | "ramp";

export interface BuildWaveformOptions {
...
export function buildWaveform(options: BuildWaveformOptions): string[] {
...
export function normalizeCustomFrames(frames: string[], maxFrames = MAX_PULSE_FRAMES_PER_SEND): string[] {
  if (frames.length === 0) {
